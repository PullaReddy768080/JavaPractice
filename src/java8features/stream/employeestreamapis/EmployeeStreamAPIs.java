...
public class EmployeeStreamAPIs {
    ...
    public static void main(String[] args) {
        ...
        Employee employee2 = new Employee(2, "dept-2", "emp-2", 100.24);
        Employee employee3 = new Employee(3, "dept-3", "emp-3", 200.54);
        Employee employee4 = new Employee(4, "dept-4", "emp-4", 300.84);
       ...
       /* //Static  methode references
        ...
        employee.setName("chinna"); //setting a name
